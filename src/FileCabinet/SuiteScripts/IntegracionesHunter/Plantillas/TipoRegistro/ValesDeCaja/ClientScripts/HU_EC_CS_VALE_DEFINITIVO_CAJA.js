...
define([ 'N/url','N/runtime'], (url, runtime) => {
    ...
    const CUSTOM_SCRIPT_PRINT_EXPENSEREPORT = "customscript_hu_ec_st_vale_definitivo";
    const CUSTOM_DEPLOYMENT_PRINT_EXPENSEREPORT = "customdeploy_hu_ec_st_vale_definitivo";
