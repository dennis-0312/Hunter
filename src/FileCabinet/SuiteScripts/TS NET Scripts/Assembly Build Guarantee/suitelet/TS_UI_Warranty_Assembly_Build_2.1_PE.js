...
define([
    ...
    'N/task',
    'N/redirect',
    './lib/TS_LBRY_Warranty_Assembly_Build_2.1_PE.js'
    ...
    const onRequest = (context) => {
        try {
            ...
            if (method == 'GET') {
                ...
                userInterface.init();
                form.setClientScript("../TS_CS_Warranty_Assembly_Build_2.1_PE.js")
    ...
    const getParametersForSchedule = (parameters, comercialData, alquilerData) => {
        ...
        scriptParameters.custscript_ts_ss_buil_inv_adj_assembl_pe = 'garantia';
