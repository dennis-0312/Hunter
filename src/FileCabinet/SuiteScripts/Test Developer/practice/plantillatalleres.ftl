...
<pdf>
    ...
    <body padding="0.3in 0.5in 0.3in 0.3in" size="Letter">
        <table style="font-size:10pt;width:100%;">
            <tr>
                <td style="font-weight: bold;">CARRO SEGURO CARSEG S.A. / OS ${ordenservicio.tranid}</td>
                <td rowspan="2"><img
                        ...
                        style="width: 50px; height: 60px; margin-left: 400px; margin-top: -50px" /></td>
            </tr>
        </table>
        ...
        <table>
            <tr>
                <td>Campo 1: ${ordenservicio.entity.entityid}</td>
                <td>Campo 2: ${ordenservicio.opportunity.entity.salesrep}</td>
            </tr>
        </table>
        <!--bloque1-->
        <!-- <table border="1" style="margin-top: 10px; width: 400px;">
            <tr>
                ...
                <td colspan="10" align="left" class="border" style="font-size: 10px;">GUAYAQUIL VERNAZA 10/may/13 -
                    16:42:05 - VBENAV - DGYESIS116</td>
            </tr>
            <tr>
                <td align="left" colspan="3" style="font-weight: bold">ID. Cliente</td>
                <td align="left" class="border">:</td>
                <td colspan="10" align="left" class="border" style="font-size: 10px;">0904795184</td>
            </tr>
            <tr>
                <td align="left" colspan="3" style="font-weight: bold">Cliente</td>
                <td align="left" class="border">:</td>
                <td colspan="10" align="left" class="border" style="font-size: 10px;">MARCELO HAON ARIAS</td>
            </tr>
            <tr>
