    ...
    (log, search, record, https, url) => {
        ...
        return ({
            envioPXAdminInstall: (Dispositivo, vehiculo, Propietario, PropietarioMonitero, id) => {
                ...
                log.error("Propietario", Propietario);
                log.error("PropietarioMonitero", PropietarioMonitero);
                ...
                let unidad = "", modelo = "", operador = "";
                if (Dispositivo.custrecord_ht_mc_modelo.length) {
                    unidad = Dispositivo.custrecord_ht_mc_modelo[0].text.split(' - ');
                }
                if (Dispositivo.custrecord_ht_mc_unidad.length) {
                    modelo = Dispositivo.custrecord_ht_mc_unidad[0].text.split(' - ');
                }
                if (Dispositivo.custrecord_ht_mc_operadora.length) {
                    operador = Dispositivo.custrecord_ht_mc_operadora[0].text.split(' - ');
                }
                ...
                if (!pxadminfinalizacion) {
                    let PxAdmin = {
                        ...
                        DescModelo: vehiculo.custrecord_ht_bien_modelo[0].text,
                        ...
                        NombreMonitorea: PropietarioMonitero.custentity_ht_cl_primernombre + ' ' + typeof PropietarioMonitero.custentity_ht_cl_segundonombre != 'undefined' ? PropietarioMonitero.custentity_ht_cl_segundonombre : '',
            ...
            envioPXAdminUninstall: (Dispositivo, vehiculo, id) => {
                let order = record.load({ type: 'customrecord_ht_record_ordentrabajo', id: id });
