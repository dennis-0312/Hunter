...
define(['N/runtime', 'N/search', 'N/config', 'N/render', 'N/record', 'N/file', './PE_LIB_Libros.js', 'N/format'], (runtime, search, config, render, record, file, libPe, format) => {
        ...
        const map = (context) => {
            try {
                ...
                var resultTransactions = {
                    ...
                    idInterno: (dataMap[15] == "" ? 0 : dataMap[15])
                };
        ...
        const summarize = (context) => {
            ...
            getParameters();
            getSubdiary();
            pGloblas['pRecordID'] = libPe.createLog(pGloblas.pSubsidiary, pGloblas.pPeriod, "Consignador 9.1")
            var transactionJSON = {};
        ...
        const getFileName = () => {
            return `LE${companyRuc}${year}${month}00090100001${hasInfo}11_${pGloblas.pRecordID}.pdf`;
        ...
        const getTemplate = () => {
            var aux = file.load("./Template/PE_Template9_1ConsigConsignador.ftl");
        ...
        const getTransactions = () => {
            ...
            var _cont = 0;
            // PE - Libro Diario 9.1
            var savedSearch = search.load({ id: 'customsearch_pe_libro_impreso_9_1' });
