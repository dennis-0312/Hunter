...
define(['N/record',
    ...
    function (record, log, runtime, search, query, _constant) {
        ...
        const getScriptParameters = () => {
            ...
            scriptParameters.alquiler = currentScript.getParameter('custscript_ts_ss_buil_inv_adj_alq_pe') ? JSON.parse(currentScript.getParameter('custscript_ts_ss_buil_inv_adj_alq_pe')) : "";
            scriptParameters.comercial = JSON.parse(currentScript.getParameter('custscript_ts_ss_buil_inv_adj_comer_pe'));
            scriptParameters.customer = currentScript.getParameter('custscript_ts_ss_buil_inv_adj_cust_pe');
            scriptParameters.location = currentScript.getParameter('custscript_ts_ss_buil_inv_adj_loc_pe');
            scriptParameters.item = currentScript.getParameter('custscript_ts_ss_buil_inv_adj_item_pe') || "";
            scriptParameters.workorder = currentScript.getParameter('custscript_ts_ss_buil_inv_adj_workor_pe') || "";
            scriptParameters.salesorder = currentScript.getParameter('custscript_ts_ss_buil_inv_adj_salesor_pe') || "";
            scriptParameters.esCustodia = currentScript.getParameter('custscript_ts_ss_buil_inv_adj_escusto_pe') || "";
            scriptParameters.deviceItem = currentScript.getParameter('custscript_ts_ss_buil_inv_adj_device_pe');
            scriptParameters.inventoryNumber = currentScript.getParameter('custscript_ts_ss_buil_inv_adj_invtnum_pe');
            scriptParameters.deviceInventoryNumberId = currentScript.getParameter('custscript_ts_ss_buil_inv_adj_reinnum_pe');
            scriptParameters.assemblyFlow = currentScript.getParameter('custscript_ts_ss_buil_inv_adj_assembl_pe');
            scriptParameters.datosTecnicos = currentScript.getParameter('custscript_ts_ss_buil_inv_adj_datotec_pe');
            scriptParameters.subsidiary = currentScript.getParameter('custscript_ts_ss_buil_inv_adj_subsidi_pe');
        ...
        const updateWorkOrder = (chaserId, workOrderId, assemblyFlow, paramLocation, vid) => {
            log.debug('updateWorkOrderEntry', `${chaserId} - ${workOrderId} - ${paramLocation} - ${assemblyFlow} - ${vid} `);
