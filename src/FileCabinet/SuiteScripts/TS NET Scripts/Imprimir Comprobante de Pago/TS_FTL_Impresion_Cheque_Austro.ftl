...
<body padding="0in 0in 0in 0in" size="A4">
    ...
    <table class="tablacheque" >
        ...
        <tbody>
            <tr>
                <td align="left" width="34.29%"></td>
                <td align="left" width="65.71%" colspan="4"></td>
            </tr>
            <tr>
                <td align="left" width="34.29%"></td>
                <td align="left" width="4.76%"></td>
                <td align="left" width="1.98%"></td>
                <td align="left" width="45.72%">${record.vendoPayment.beneficiario}</td>
                <td align="left" width="12.85%">${record.vendoPayment.montoTotal}</td>
            </tr>
            <tr>
                <td align="left" width="34.29%"></td>
                <td align="left" width="65.71%" colspan="4"></td>
            ...
            <tr>
                <td align="left" width="34.29%"></td>
                <td align="left" width="4.76%"></td>
                <td align="left" width="60.95%" colspan="3">${record.vendoPayment.total}</td>
            </tr>
            <tr>
                <td align="left" width="34.29%"></td>
                <td align="left" width="65.71%" colspan="4"></td>
            ...
            <tr>
                <td align="left" width="34.29%"></td>
                <td align="left" width="65.71%" colspan="4">${record.vendoPayment.fechaUbica}</td>
            </tr>
        </tbody>
    </table>
