...
<#if emitido == "SI">
${detailType}${setPadding(payment_index + 1,"left","0",6)}${setPadding(vatregnumber,"right"," ",18)}${docType}${setPadding(vatregnumber,"right"," ",14)}${setPadding(entity.altname?replace('ñ','n')?replace('Ñ','N')?replace('Á','A')?replace('á','a')?replace('É','E')?replace('é','e')?replace('Í','I')?replace('í','i')?replace('Ó','O')?replace('ó','o')?replace('Ú','U')?replace('ú','u')?replace("[^a-zA-Z0-9 ]", "", "r"),"right"," ",60)}${setPadding(codTerminoPago,"right"," ",3)}001${setPadding(codigoBanco,"right"," ",2)}${setPadding(codTermino,"right"," ",2)}${setPadding(account,"right"," ",10)}${setPadding(nrocheque,"left","0",10)}1${totalAmount?string["0000000000000.00"]?replace('.','')}${setPadding(glosa?replace('ñ','n')?replace('Ñ','N')?replace('Á','A')?replace('á','a')?replace('É','E')?replace('é','e')?replace('Í','I')?replace('í','i')?replace('Ó','O')?replace('ó','o')?replace('Ú','U')?replace('ú','u')?replace("[^a-zA-Z0-9 ]", "", "r"),"right"," ",60)}${setPadding(auxiliarEspacio,"right"," ",195)}CCH${setPadding(auxiliarEspacio,"right"," ",30)}N${setPadding(codigoEmpresa,"right"," ",5)}
<#--  ${pruebaVar}
${emitido}  -->
<#else>
${detailType}${setPadding(payment_index + 1,"left","0",6)}${setPadding(vatregnumber,"right"," ",18)}${docType}${setPadding(vatregnumber,"right"," ",14)}${setPadding(entity.altname?replace('ñ','n')?replace('Ñ','N')?replace('Á','A')?replace('á','a')?replace('É','E')?replace('é','e')?replace('Í','I')?replace('í','i')?replace('Ó','O')?replace('ó','o')?replace('Ú','U')?replace('ú','u')?replace("[^a-zA-Z0-9 ]", "", "r"),"right"," ",60)}${setPadding(codTerminoPago,"right"," ",3)}001${setPadding(codigoBanco,"right"," ",2)}${setPadding(codTermino,"right"," ",2)}${setPadding(account,"right"," ",20)}1${totalAmount?string["0000000000000.00"]?replace('.','')}${setPadding(glosa?replace('ñ','n')?replace('Ñ','N')?replace('Á','A')?replace('á','a')?replace('É','E')?replace('é','e')?replace('Í','I')?replace('í','i')?replace('Ó','O')?replace('ó','o')?replace('Ú','U')?replace('ú','u')?replace("[^a-zA-Z0-9 ]", "", "r"),"right"," ",60)}${setPadding(transaction.internalid.value,"left","0",15)}${setPadding(rete,"left","0",15)}${setPadding(rete,"left","0",15)}${setPadding(sustento,"left","0",20)}${setPadding(auxiliarEspacio,"right"," ",10)}${setPadding(auxiliarEspacio,"right"," ",50)}${setPadding(entity.address?replace('<br />',' ')?replace('\n',' ')?replace('ñ','n')?replace('Ñ','N')?replace('Á','A')?replace('á','a')?replace('É','E')?replace('é','e')?replace('Í','I')?replace('í','i')?replace('Ó','O')?replace('ó','o')?replace('Ú','U')?replace('ú','u')?replace("[^a-zA-Z0-9 ]", "", "r"),"right"," ",50)}${setPadding(telefono?replace("+593","")?replace("+19",""),"right"," ",20)}PRO${setPadding(autorizacion,"right"," ",10)}${setPadding(auxiliarEspacio,"right"," ",20)}N${setPadding(codigoEmpresa,"right"," ",5)}${setPadding(auxiliarEspacio,"right"," ",6)}RPA${setPadding(fechaAutorizacion,"right"," ",10)}
<#--  ${pruebaVar}
${emitido}  -->
</#if>
