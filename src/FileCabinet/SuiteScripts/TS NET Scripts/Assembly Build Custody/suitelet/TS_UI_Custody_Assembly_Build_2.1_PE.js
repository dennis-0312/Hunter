...
define([
    ...
    'N/task',
    'N/redirect',
    './lib/TS_LBRY_Custody_Assembly_Build_2.1_PE.js',
    'N/search'
    ...
    const onRequest = (context) => {
        try {
            ...
            if (method == 'GET') {
                ...
                userInterface.init();
                form.setClientScript("../TS_CS_Custody_Assembly_Build_2.1_PE.js")
    ...
    const getParametersForSchedule = (parameters, comercialData, alquilerData) => {
        ...
        scriptParameters.custscript_ts_ss_buil_inv_adj_item_pe = parameters.custpage_f_reinstallitem || "";
        scriptParameters.custscript_ts_ss_buil_inv_adj_device_pe = parameters.custpage_f_deviceitem || "";
        ...
        scriptParameters.custscript_ts_ss_buil_inv_adj_invtnum_pe = parameters.custpage_f_inventorynumber || "";
        scriptParameters.custscript_ts_ss_buil_inv_adj_reinnum_pe = parameters.custpage_f_inventorynumberid || "";
        scriptParameters.custscript_ts_ss_buil_inv_adj_subsidi_pe = parameters.custpage_f_subsidiary || "";
        scriptParameters.custscript_ts_ss_buil_inv_adj_assembl_pe = 'custodia';
