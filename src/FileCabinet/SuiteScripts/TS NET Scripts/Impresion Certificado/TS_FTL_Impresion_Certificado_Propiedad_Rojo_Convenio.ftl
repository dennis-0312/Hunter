    ...
    <pdf>
        ...
        <body footer="nlfooter" footer-height="3.5em" padding="0.5in 0.5in 0.5in 0.5in" size="A7"> 
            <div>
                ...
                <#list record.codigobarras as item>
                <tr>
                    <td>
                        <#if companyInformation.logoUrl?length !=0>
                            <@filecabinet nstype="image" src="${companyInformation.logoUrl}"
                            style="float: left; width: 70px; height: 25px;" />
                        </#if>
                    </td>
                </tr>
                <tr><td rowspan="5" style="font-size: 8px"><barcode codetype="code25" showtext="true" value="${item}" width="62" height="17"/></td></tr>
                </#list>  
                </table>
            </div>
