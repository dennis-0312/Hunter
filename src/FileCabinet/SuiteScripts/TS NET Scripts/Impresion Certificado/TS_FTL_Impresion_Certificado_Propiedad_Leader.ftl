            ...
            <table>
                <tr>
                    <td style="border: 0px" align="center">
                        <img src="${record.imagen.L_Link_cabecera}" style="float: left; width: 430px; height: 50px;" />
                    </td>
                </tr>
            </table>
        </macro>
...
<body size="A5" header="nlheader" header-height="10%" style="border: 4px double black;">    <h2 align="center" style="font-size: 12px"><mark>CERTIFICADO DE VENTA</mark></h2>
    <p align="right"><b> C.V. ${record.workOrder.custrecord_ht_ot_vehiculo}</b></p>
    <p align="center">Certificamos que el Sr./Sra. <b>${record.customer.companyname}</b></p>
    ...
    <p align="left">Estos sistemas se encuentran instalados en el (Vehículo/Barco/Avión/Cajero) con las siguientes características:</p>
