                ...
                if (IdOrdenTrabajo.length > 0) {
                    try {
                        ...
                        if (item) {
                            ...
                            // let esVentaPR = parametrizacionProducto[_constant.Codigo_parametro.COD_AVP_ARTICULO_DE_VENTA_PRODUCCION];
                            ...
                            log.debug('pro', pro);
                            log.debug('avp', avp);
                            //if (!(esCandado !== undefined && esCandado.valor == _constant.Codigo_Valor.COD_SI) || (esVentaPR !== undefined && esVentaPR.valor == _constant.Codigo_Valor.COD_SI)) {
