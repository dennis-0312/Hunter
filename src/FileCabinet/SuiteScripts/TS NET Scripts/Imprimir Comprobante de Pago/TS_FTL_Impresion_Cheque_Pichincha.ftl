...
<body padding="0in 0in 0in 0in" size="A4">
    ...
    <table class="tablacheque" >
        ...
        <tbody>
            ...
            <tr>
                <td align="left" width="34.29%"></td>
                <td align="left" width="6.19%"></td>
                <td align="left" width="2.38%"></td>
                <td align="left" width="45.24%">${record.vendoPayment.beneficiario}</td>
                <td align="left" width="11.9%">${record.vendoPayment.montoTotal}</td>
            </tr>
            <tr>
                <td align="left" width="34.29%"></td>
                <td align="left" width="65.71%" colspan="4"></td>
            ...
            <tr>
                <td align="left" width="34.29%"></td>
                <td align="left" width="6.19%"></td>
                <td align="left" width="59.52%" colspan="3">${record.vendoPayment.total}</td>
            </tr>
            <tr>
                <td align="left" width="34.29%"></td>
                <td align="left" width="65.71%" colspan="4"></td>
