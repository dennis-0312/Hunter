...
define([
    ...
    'N/task',
    'N/redirect',
    './lib/TS_LBRY_Assembly_Build_2.1_PE.js',
    'N/search'
    ...
    const onRequest = (context) => {
        try {
            ...
            if (method == 'GET') {
                ...
                userInterface.init();
                form.setClientScript("../TS_CS_Assembly_Build_2.1_PE.js")
    ...
    const getParametersForSchedule = (parameters, comercialData, alquilerData) => {
        ...
        scriptParameters.custscript_ts_ss_buil_inv_adj_alq_pe = alquilerData;
        scriptParameters.custscript_ts_ss_buil_inv_adj_comer_pe = comercialData;
        scriptParameters.custscript_ts_ss_buil_inv_adj_cust_pe = parameters.custpage_f_customer || "";
        scriptParameters.custscript_ts_ss_buil_inv_adj_loc_pe = parameters.custpage_f_location || "";
        scriptParameters.custscript_ts_ss_buil_inv_adj_item_pe = parameters.custpage_f_item || "";
        scriptParameters.custscript_ts_ss_buil_inv_adj_workor_pe = parameters.custpage_f_workorder || "";
        scriptParameters.custscript_ts_ss_buil_inv_adj_salesor_pe = parameters.custpage_f_salesorder || "";
        scriptParameters.custscript_ts_ss_buil_inv_adj_assembl_pe = 'alquiler';
        scriptParameters.custscript_ts_ss_buil_inv_adj_datotec_pe = parameters.custpage_field_datos_tecnicos || "";
        scriptParameters.custscript_ts_ss_buil_inv_adj_subsidi_pe = parameters.custpage_f_subsidiary || "";
    ...
    const taskSchedule = (params) => {
        ...
        let scriptTask = task.create({
            ...
            scriptId: 'customscript_ts_ss_build_inv_adjus_pe',
            deploymentId: 'customdeploy_ts_ss_build_inv_adjus_pe',
            params
        });
        ...
        var inventorynumberbinSearchObj = search.create({
            ...
            columns:
                [
                    ...
                    search.createColumn({ name: "custrecord_deposito_para_bodega_comercia", join: "binNumber", label: "Deposito para bodega comercial" }),
                    search.createColumn({ name: "custrecord_deposito_para_alquiler", join: "binNumber", label: "Depósito para Alquiler" }),
...
// {
//    "success": true,
//    "message": "Transacción 15264 anulada",
//    "result": [
//         {
//             "invoice": "14525",
//             "message": "Anulada" 
