...
<body padding="0in 0in 0in 0in" size="A4">
    ...
    <table class="tablacheque" >
        ...
        <tbody>
            <tr>
                <td align="left" width="32.38%"></td>
                <td align="left" width="67.62%" colspan="4"></td>
            </tr>
            <tr>
                <td align="left" width="32.38%"></td>
                <td align="left" width="5.72%"></td>
                <td align="left" width="2.37%"></td>
                <td align="left" width="46.2%">${record.vendoPayment.beneficiario}</td>
                <td align="left" width="13.33%">${record.vendoPayment.montoTotal}</td>
            </tr>
            <tr>
                <td align="left" width="32.38%"></td>
                <td align="left" width="67.62%" colspan="4"></td>
            ...
            <tr>
                <td align="left" width="32.38%"></td>
                <td align="left" width="5.72%"></td>
                <td align="left" width="61.9%" colspan="3">${record.vendoPayment.total}</td>
            </tr>
            <tr>
                <td align="left" width="32.38%"></td>
                <td align="left" width="67.62%" colspan="4"></td>
            ...
            <tr>
                <td align="left" width="32.38%"></td>
                <td align="left" width="67.62%" colspan="4">${record.vendoPayment.fechaUbica}</td>
            </tr>
        </tbody>
    </table>
