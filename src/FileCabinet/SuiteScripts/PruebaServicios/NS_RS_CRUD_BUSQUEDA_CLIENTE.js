 ...
 define(['N/log','N/search'], function(log, search) {
    function _get(context) {
        try{
            ...
            //let P_IdOficina = context.v_CodigoCliente;
           ...
           log.debug('Request...1.....', context.OPCION);
log.debug('Request.111.....', context.CodigoCliente);
          
log.debug('Request.22.....', context.Oficina);
          
log.debug('Request..33.....', context.IdTipoCliente);
