...
define(['N/ui/serverWidget', 'N/search', 'N/url', 'N/query', 'N/file'], (serverWidget, search, url, query, file) => {
    ...
    class Parameters {
        constructor({ item, workorder, salesorder, customer, location, subsidiary, relateditem, device }) {
    ...
    class UserInterface {
        ...
        getFormattedParameters = () => {
            ...
            this.PARAMETERS.device = this.PARAMETERS.device || this.CONSTANT.EMPTY_SELECT_VALUE;
