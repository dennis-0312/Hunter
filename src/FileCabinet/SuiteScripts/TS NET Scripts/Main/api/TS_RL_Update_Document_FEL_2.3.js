...
function (log, search, record, config, format){
    ...
    const put = (requestBody) => {
        try {
            ...
            if (!requestBody.estadoAutorizacion) return new CustomError(ERROR_STATUS_CODE, "ERROR", "Introduzca un valor correcto para estadoAutorizacion");
    ...
    const updateTransaction = (requestBody) => {
        ...
        let id = record.submitFields({
            ...
            values: {
                ...
                "custbody_ec_estado_de_autorizaci": requestBody.estadoAutorizacion
            }
        });
        return id;
    }
