<#assign record = record.text?eval>
<?xml version="1.0"?>
    ...
    <pdf>
        ...
        <body footer="nlfooter" footer-height="3.5em" padding="0.5in 0.5in 0.5in 0.5in" size="A7"> 
                <!--
                <p>${record.codigobarras?size}</p>
                <#list record.codigobarras as hoja>
                <p>${hoja?size}</p>
                <#list hoja as fila>
                <p>${fila?size}</p>
                </#list>  
                ...
                <#list hoja as fila>
                    <tr>
                        <td align="left">
                            ...
                            <p>
                                <barcode codetype="code25" showtext="true" value="${fila[0]}" width="55" height="17"/>
                            </p>
                        </td>
                        <#if fila?size == 2>
                        <td align="left">
                            ...
                            <p>
                                <barcode codetype="code25" showtext="true" value="${fila[1]}" width="55" height="17"/>
                            </p>
                        </td>
                        </#if>
                    </tr>
