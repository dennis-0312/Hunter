...
*/
 ...
 function (search, record, runtime, log, file, config, format, task) {
    ...
    const getScriptParameters = (environmentFeatures) => {
        ...
        scriptParameters.subsidiaryId = currentScript.getParameter('custscript_ts_sc_ple_9_1_subsidiary');
        scriptParameters.periodId = currentScript.getParameter('custscript_ts_sc_ple_9_1_period');
        scriptParameters.format = currentScript.getParameter("custscript_ts_sc_ple_9_1_format");
        scriptParameters.folderId = currentScript.getParameter("custscript_ts_sc_ple_9_1_folderid");
        scriptParameters.page = Number(currentScript.getParameter("custscript_ts_sc_ple_9_1_num_pag")) || 0;
        scriptParameters.auxiliaryFileNumber = Number(currentScript.getParameter("custscript_ts_sc_ple_9_1_num_archv")) || 0;
    ...
    const createLogRecord = (scriptParameters, hasSubsidiariesFeature) => {
        try {
            ...
            logRecord.setValue("custrecord_pe_book_log", "Registro de Consignaciones 9.1");
    ...
    const getTransactions = (scriptParameters, environmentFeatures, auxiliaryRecords) => {
        let transactionSearch = search.load({ id: "customsearch_pe_libro_mayor_9_1" });
    ...
    const getRow = (result, columns, separator) => {
        ...
        rowArray[0] = result.getValue(columns[5]);
        ...
        rowArray[22] = result.getValue(columns[21]);
    ...
    const getFileName = (auxiliaryRecords, auxiliaryFileNumber, auxiliaryFileContentSize) => {
        ...
        return `LE${auxiliaryRecords.subsidiary.taxidnum}${auxiliaryRecords.period.year}${auxiliaryRecords.period.month}00090100001${hasInfo}11_${auxiliaryFileNumber}`;
    }
    ...
    const getHeader = () => {
        ...
        '14 Numero del Comprobante de Pago emitido por el consignador (1)|15 Fecha de entrega o devolucion del bien|16 Tipo de documento de identidad del consignatario|17 Numero de RUC del consignatario o del documento de identidad|'+
        '18 Apellidos y Nombres, Denominacion o Razon Social del consignatario|19 Cantidad de bienes entregados en consignacion (la primera tupla corresponde al saldo inicial)|20 Cantidad de bienes devueltos por el consignatario|21 Cantidad de bienes vendidos|22 Indica el estado de la operacion|\n';
    }
    ...
    const updateLogRecord = (logRecordId, loadedFile, fileName, scriptParameters, environmentFeatures) => {
        ...
        values.custrecord_pe_book_log = 'Registro Consignacion 9.1';
    ...
    const executeScriptRecall = (scriptParameters) => {
        ...
        params["custscript_ts_sc_ple_9_1_subsidiary"] = scriptParameters.subsidiaryId;
        params["custscript_ts_sc_ple_9_1_period"] = scriptParameters.periodId;
        params["custscript_ts_sc_ple_9_1_format"] = scriptParameters.format;
        params["custscript_ts_sc_ple_9_1_num_pag"] = scriptParameters.page;
        params["custscript_ts_sc_ple_9_1_folderid"] = scriptParameters.folderId
        params["custscript_ts_sc_ple_9_1_num_archv"] = scriptParameters.auxiliaryFileNumber;

        log.error("executeScriptRecall Params", params);
        let scheduledTask = task.create({
            taskType: task.TaskType.SCHEDULED_SCRIPT,
            scriptId: 'customscript_ts_sc_ple_9_1_regist_consig',
            deploymentId: 'customdeploy_ts_sc_ple_9_1_regist_consig',
            params
        });
